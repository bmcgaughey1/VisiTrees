...
A subset of the FIA tree list that includes FIA species codes <1000 was extracted along with the 10 additional species from the FHM list to serve as the starting point for VisiTrees. The v9-2_2-22-09... files are the FIA lists used as the initial species list. These should not be used for any additional work.
