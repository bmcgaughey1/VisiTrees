...
A subset of the FIA tree list that includes FIA species codes <1000 was extracted along with the 100 additional species from the FHM list to serve as the starting point for VisiTrees.
